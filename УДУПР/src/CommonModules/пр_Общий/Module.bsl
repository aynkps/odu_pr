...
Процедура ИнформацияОСистемеНаСервере(ИнформацияОСистеме) Экспорт
	
	ИнформацияОСистеме.Вставить("РежимСовместимостиИнтерфейса", Строка(Метаданные.РежимСовместимостиИнтерфейса));   
	РежимСовместимости = СтрЗаменить(Метаданные.РежимСовместимости, "Версия","");
	ИнформацияОСистеме.Вставить("РежимСовместимости", Число(Лев(СтрЗаменить(РежимСовместимости, "_",""), 3))); 
