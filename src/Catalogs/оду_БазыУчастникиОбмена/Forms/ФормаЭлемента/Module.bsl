...
Процедура СоставОбъектПриИзменении(Элемент) 
	...
	ТипXML = пр_Общий.ТипXMLПустогоЗначенияИзИдентификатораОбъектаМетаданных(ТекЭлемент.Объект); 
	
	ТекЭлемент.ТипXMLОбъектаИсточника = ТипXML;
	ТекЭлемент.ТипXMLОбъектаПриемника = ТипXML;  //По умолчанию они равны 
	ТекЭлемент.Регистрировать = ТипXML <> "";
	ТекЭлемент.ИспользоватьСамолет = ТипXML <> "";
